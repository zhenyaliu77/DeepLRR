...
def CalculateFirst(groupsite):
    #Why not average, because segments between two LRRs tend to average very highly
    #You can't pick max value it for the same reason
    #The best is to get a 20aa score
    mean_dic = {}
    for key in groupsite.keys():
...
def BestScoreAA(groupsite,clip_n):
    #20aa can have at most 1 LRR unit
