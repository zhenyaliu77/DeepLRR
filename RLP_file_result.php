	...
	<body >
		<div style="width: 1350px;margin: auto;background-color: white;">
			...
			<div id="main" style="width: 1350px;">
					...
					<div style="margin: auto;text-align: center;width: 900px;height: auto !important;hieght:600px;min-height:600px;;">
					...
					<?php           
                                        ...
                                        if($ctrl){
                                                if($step == "1"){
                                                ?>
        <p style="margin: auto;text-align:center;font-size:200%;">No LRR-RLP<br><br>If refreshed, please resubmit</p>
                                                <?php
                                                }else if($step == "2"){
                                                ?>
